package Ques19;
    ...
    public class Solution {
       ...
       public static String convert(int n)
       {
           ...
           // add digits at ten million and a hundred million place
           ...
           // add digits at a hundred thousand and one million place
           res.append(convertToDigit(((n / 100000) % 100), "Lakh, "));


           // add digits at a thousand and tens a thousand place
           res.append(convertToDigit(((n / 1000) % 100), "Thousand "));


           // add digit at a hundred place
       ...
       public static void main(String[] args)
       {
           ...
           // System.out.println(convert(Integer.MAX_VALUE));        3214748367
       }
   }